...
const pageRequirements: Record<string, Requirement[]> = {
  "accounts-page": [
    { id: "payment-methods", label: "1. Payment Methods Setup", checked: false, icon: "💰", subFields: [
      { id: "pm-card-type", label: "1.1 Card Type", checked: false, required: false },
      { id: "pm-card-number", label: "1.2 Card Number", checked: false, required: false },
      { id: "pm-expiry-date", label: "1.3 Expiry Date", checked: false, required: false },
      { id: "pm-cvv", label: "1.4 CVV", checked: false, required: false },
      { id: "pm-billing-address", label: "1.5 Billing Address", checked: false, required: false },
    ]},
    { id: "billing-info", label: "2. Billing Information", checked: false, icon: "🏦", subFields: [
      { id: "bi-company-name", label: "2.1 Company Name", checked: false, required: false },
      { id: "bi-tax-id", label: "2.2 Tax ID", checked: false, required: false },
      { id: "bi-address", label: "2.3 Address", checked: false, required: false },
      { id: "bi-contact-email", label: "2.4 Contact Email", checked: false, required: false },
    ]},
    { id: "subscription-plans", label: "3. Subscription Plans", checked: false, icon: "📋", subFields: [
      { id: "sp-plan-name", label: "3.1 Plan Name", checked: false, required: false },
      { id: "sp-price", label: "3.2 Price", checked: false, required: false },
      { id: "sp-billing-cycle", label: "3.3 Billing Cycle", checked: false, required: false },
      { id: "sp-features", label: "3.4 Features List", checked: false, required: false },
    ]},
    { id: "invoice-list", label: "4. Invoice List", checked: false, icon: "📄", subFields: [
      { id: "il-invoice-number", label: "4.1 Invoice Number", checked: false, required: false },
      { id: "il-date", label: "4.2 Date", checked: false, required: false },
      { id: "il-amount", label: "4.3 Amount", checked: false, required: false },
      { id: "il-status", label: "4.4 Status", checked: false, required: false },
      { id: "il-download", label: "4.5 Download PDF", checked: false, required: false },
    ]},
    { id: "payment-history", label: "5. Payment History", checked: false, icon: "💳", subFields: [
      { id: "ph-transaction-id", label: "5.1 Transaction ID", checked: false, required: false },
      { id: "ph-date", label: "5.2 Date", checked: false, required: false },
      { id: "ph-amount", label: "5.3 Amount", checked: false, required: false },
      { id: "ph-method", label: "5.4 Payment Method", checked: false, required: false },
      { id: "ph-status", label: "5.5 Status", checked: false, required: false },
    ]},
  ],
  "admin-page": [
    { id: "system-settings", label: "1. System Settings", checked: false, icon: "⚙️", subFields: [
      { id: "ss-site-name", label: "1.1 Site Name", checked: false, required: false },
      { id: "ss-logo", label: "1.2 Logo Upload", checked: false, required: false },
      { id: "ss-timezone", label: "1.3 Timezone", checked: false, required: false },
      { id: "ss-language", label: "1.4 Language", checked: false, required: false },
      { id: "ss-maintenance-mode", label: "1.5 Maintenance Mode", checked: false, required: false },
    ]},
    { id: "user-management", label: "2. User Management", checked: false, icon: "👥", subFields: [
      { id: "um-user-list", label: "2.1 User List", checked: false, required: false },
      { id: "um-add-user", label: "2.2 Add User", checked: false, required: false },
      { id: "um-edit-user", label: "2.3 Edit User", checked: false, required: false },
      { id: "um-delete-user", label: "2.4 Delete User", checked: false, required: false },
      { id: "um-user-status", label: "2.5 User Status", checked: false, required: false },
    ]},
    { id: "role-permissions", label: "3. Role Permissions", checked: false, icon: "🔐", subFields: [
      { id: "rp-role-name", label: "3.1 Role Name", checked: false, required: false },
      { id: "rp-permissions", label: "3.2 Permissions List", checked: false, required: false },
      { id: "rp-assign-users", label: "3.3 Assign Users", checked: false, required: false },
    ]},
    { id: "audit-logs", label: "4. Audit Logs", checked: false, icon: "📋", subFields: [
      { id: "al-timestamp", label: "4.1 Timestamp", checked: false, required: false },
      { id: "al-user", label: "4.2 User", checked: false, required: false },
      { id: "al-action", label: "4.3 Action", checked: false, required: false },
      { id: "al-ip-address", label: "4.4 IP Address", checked: false, required: false },
    ]},
    { id: "analytics-dashboard", label: "5. Analytics Dashboard", checked: false, icon: "📊", subFields: [
      { id: "ad-total-users", label: "5.1 Total Users", checked: false, required: false },
      { id: "ad-active-sessions", label: "5.2 Active Sessions", checked: false, required: false },
      { id: "ad-page-views", label: "5.3 Page Views", checked: false, required: false },
      { id: "ad-growth-chart", label: "5.4 Growth Chart", checked: false, required: false },
    ]},
  ],
  "blog-page": [
    { id: "blog-list", label: "1. Blog List", checked: false, icon: "📝", subFields: [
      { id: "bl-title", label: "1.1 Title", checked: false, required: false },
      { id: "bl-excerpt", label: "1.2 Excerpt", checked: false, required: false },
      { id: "bl-featured-image", label: "1.3 Featured Image", checked: false, required: false },
      { id: "bl-author", label: "1.4 Author", checked: false, required: false },
      { id: "bl-date", label: "1.5 Publish Date", checked: false, required: false },
      { id: "bl-category", label: "1.6 Category", checked: false, required: false },
    ]},
    { id: "blog-detail", label: "2. Blog Detail", checked: false, icon: "📄", subFields: [
      { id: "bd-full-content", label: "2.1 Full Content", checked: false, required: false },
      { id: "bd-author-bio", label: "2.2 Author Bio", checked: false, required: false },
      { id: "bd-related-posts", label: "2.3 Related Posts", checked: false, required: false },
      { id: "bd-social-share", label: "2.4 Social Share Buttons", checked: false, required: false },
    ]},
    { id: "comments", label: "3. Comments Section", checked: false, icon: "💬", subFields: [
      { id: "cs-comment-list", label: "3.1 Comment List", checked: false, required: false },
      { id: "cs-add-comment", label: "3.2 Add Comment", checked: false, required: false },
      { id: "cs-reply", label: "3.3 Reply to Comment", checked: false, required: false },
      { id: "cs-like", label: "3.4 Like/Dislike", checked: false, required: false },
    ]},
    { id: "categories", label: "4. Categories & Tags", checked: false, icon: "🏷️", subFields: [
      { id: "ct-category-list", label: "4.1 Category List", checked: false, required: false },
      { id: "ct-tag-cloud", label: "4.2 Tag Cloud", checked: false, required: false },
      { id: "ct-filter", label: "4.3 Filter by Category", checked: false, required: false },
    ]},
    { id: "search", label: "5. Search", checked: false, icon: "🔍", subFields: [
      { id: "sr-search-bar", label: "5.1 Search Bar", checked: false, required: false },
      { id: "sr-search-results", label: "5.2 Search Results", checked: false, required: false },
      { id: "sr-suggestions", label: "5.3 Auto Suggestions", checked: false, required: false },
    ]},
  ],
  "contact-page": [
    { id: "contact-form", label: "1. Contact Form", checked: false, icon: "📝", subFields: [
      { id: "cf-name", label: "1.1 Name", checked: false, required: false },
      { id: "cf-email", label: "1.2 Email", checked: false, required: false },
      { id: "cf-phone", label: "1.3 Phone", checked: false, required: false },
      { id: "cf-subject", label: "1.4 Subject", checked: false, required: false },
      { id: "cf-message", label: "1.5 Message", checked: false, required: false },
      { id: "cf-submit", label: "1.6 Submit Button", checked: false, required: false },
    ]},
    { id: "contact-info", label: "2. Contact Information", checked: false, icon: "📞", subFields: [
      { id: "ci-address", label: "2.1 Address", checked: false, required: false },
      { id: "ci-phone", label: "2.2 Phone Number", checked: false, required: false },
      { id: "ci-email", label: "2.3 Email", checked: false, required: false },
      { id: "ci-hours", label: "2.4 Business Hours", checked: false, required: false },
    ]},
    { id: "map", label: "3. Map Integration", checked: false, icon: "🗺️", subFields: [
      { id: "mp-google-map", label: "3.1 Google Map", checked: false, required: false },
      { id: "mp-directions", label: "3.2 Directions Link", checked: false, required: false },
    ]},
    { id: "social-links", label: "4. Social Links", checked: false, icon: "🔗", subFields: [
      { id: "sl-facebook", label: "4.1 Facebook", checked: false, required: false },
      { id: "sl-twitter", label: "4.2 Twitter", checked: false, required: false },
      { id: "sl-linkedin", label: "4.3 LinkedIn", checked: false, required: false },
      { id: "sl-instagram", label: "4.4 Instagram", checked: false, required: false },
    ]},
  ],
  "customer-page": [
    { id: "add-customer", label: "1. Add Customer", checked: false, icon: "➕", subFields: [
      { id: "ac-name", label: "1.1 Customer Name", checked: false, required: false },
      { id: "ac-email", label: "1.2 Email", checked: false, required: false },
      { id: "ac-phone", label: "1.3 Phone", checked: false, required: false },
      { id: "ac-address", label: "1.4 Address", checked: false, required: false },
      { id: "ac-company", label: "1.5 Company", checked: false, required: false },
    ]},
    { id: "customer-list", label: "2. Customer List", checked: false, icon: "👥", subFields: [
      { id: "cl-table", label: "2.1 Data Table", checked: false, required: false },
      { id: "cl-search", label: "2.2 Search", checked: false, required: false },
      { id: "cl-filter", label: "2.3 Filters", checked: false, required: false },
      { id: "cl-actions", label: "2.4 Actions (Edit/Delete)", checked: false, required: false },
    ]},
    { id: "customer-profile", label: "3. Customer Profile", checked: false, icon: "👤", subFields: [
      { id: "cp-info", label: "3.1 Basic Info", checked: false, required: false },
      { id: "cp-orders", label: "3.2 Order History", checked: false, required: false },
      { id: "cp-notes", label: "3.3 Notes", checked: false, required: false },
    ]},
    { id: "customer-analytics", label: "4. Customer Analytics", checked: false, icon: "📊", subFields: [
      { id: "ca-total", label: "4.1 Total Customers", checked: false, required: false },
      { id: "ca-new", label: "4.2 New This Month", checked: false, required: false },
      { id: "ca-growth", label: "4.3 Growth Chart", checked: false, required: false },
    ]},
  ],
  "dashboard-page": [
    { id: "stats-cards", label: "1. Statistics Cards", checked: false, icon: "📊", subFields: [
      { id: "sc-total-sales", label: "1.1 Total Sales", checked: false, required: false },
      { id: "sc-total-orders", label: "1.2 Total Orders", checked: false, required: false },
      { id: "sc-total-customers", label: "1.3 Total Customers", checked: false, required: false },
      { id: "sc-revenue", label: "1.4 Revenue", checked: false, required: false },
    ]},
    { id: "charts", label: "2. Charts", checked: false, icon: "📈", subFields: [
      { id: "ch-line-chart", label: "2.1 Line Chart", checked: false, required: false },
      { id: "ch-bar-chart", label: "2.2 Bar Chart", checked: false, required: false },
      { id: "ch-pie-chart", label: "2.3 Pie Chart", checked: false, required: false },
      { id: "ch-area-chart", label: "2.4 Area Chart", checked: false, required: false },
    ]},
    { id: "recent-activity", label: "3. Recent Activity", checked: false, icon: "🕐", subFields: [
      { id: "ra-orders", label: "3.1 Recent Orders", checked: false, required: false },
      { id: "ra-users", label: "3.2 Recent Users", checked: false, required: false },
      { id: "ra-notifications", label: "3.3 Notifications", checked: false, required: false },
    ]},
    { id: "quick-actions", label: "4. Quick Actions", checked: false, icon: "⚡", subFields: [
      { id: "qa-add-product", label: "4.1 Add Product", checked: false, required: false },
      { id: "qa-add-order", label: "4.2 Add Order", checked: false, required: false },
      { id: "qa-generate-report", label: "4.3 Generate Report", checked: false, required: false },
    ]},
  ],
  "e-commerce-page": [
    { id: "product-listing", label: "1. Product Listing", checked: false, icon: "🛍️", subFields: [
      { id: "pl-grid-view", label: "1.1 Grid View", checked: false, required: false },
      { id: "pl-list-view", label: "1.2 List View", checked: false, required: false },
      { id: "pl-filters", label: "1.3 Filters", checked: false, required: false },
      { id: "pl-sorting", label: "1.4 Sorting", checked: false, required: false },
      { id: "pl-pagination", label: "1.5 Pagination", checked: false, required: false },
    ]},
    { id: "product-detail", label: "2. Product Detail", checked: false, icon: "📦", subFields: [
      { id: "pd-images", label: "2.1 Image Gallery", checked: false, required: false },
      { id: "pd-description", label: "2.2 Description", checked: false, required: false },
      { id: "pd-price", label: "2.3 Price", checked: false, required: false },
      { id: "pd-variants", label: "2.4 Variants", checked: false, required: false },
      { id: "pd-add-to-cart", label: "2.5 Add to Cart", checked: false, required: false },
    ]},
    { id: "shopping-cart", label: "3. Shopping Cart", checked: false, icon: "🛒", subFields: [
      { id: "sc-items", label: "3.1 Cart Items", checked: false, required: false },
      { id: "sc-quantity", label: "3.2 Quantity Update", checked: false, required: false },
      { id: "sc-subtotal", label: "3.3 Subtotal", checked: false, required: false },
      { id: "sc-checkout", label: "3.4 Checkout Button", checked: false, required: false },
    ]},
    { id: "checkout", label: "4. Checkout", checked: false, icon: "💳", subFields: [
      { id: "co-shipping", label: "4.1 Shipping Info", checked: false, required: false },
      { id: "co-payment", label: "4.2 Payment Method", checked: false, required: false },
      { id: "co-review", label: "4.3 Order Review", checked: false, required: false },
      { id: "co-confirm", label: "4.4 Confirm Order", checked: false, required: false },
    ]},
    { id: "orders", label: "5. Order Management", checked: false, icon: "📋", subFields: [
      { id: "om-order-list", label: "5.1 Order List", checked: false, required: false },
      { id: "om-order-detail", label: "5.2 Order Detail", checked: false, required: false },
      { id: "om-tracking", label: "5.3 Order Tracking", checked: false, required: false },
    ]},
  ],
  "employee-page": [
  ...
  "error-page": [
    { id: "error-code", label: "1. Error Code Display", checked: false, icon: "🔢", subFields: [
      { id: "ec-code", label: "1.1 Error Code (404/500)", checked: false, required: false },
      { id: "ec-title", label: "1.2 Error Title", checked: false, required: false },
    ]},
    { id: "error-message", label: "2. Error Message", checked: false, icon: "⚠️", subFields: [
      { id: "em-description", label: "2.1 Description Text", checked: false, required: false },
      { id: "em-suggestion", label: "2.2 Suggestion Text", checked: false, required: false },
    ]},
    { id: "animated-illustration", label: "3. Animated Illustration", checked: false, icon: "🎨", subFields: [
      { id: "ai-image", label: "3.1 Error Image/Animation", checked: false, required: false },
    ]},
    { id: "back-home", label: "4. Navigation", checked: false, icon: "🏠", subFields: [
      { id: "bh-button", label: "4.1 Home Button", checked: false, required: false },
      { id: "bh-back", label: "4.2 Back Button", checked: false, required: false },
    ]},
  ],
  "form-page": [
    { id: "form-fields", label: "1. Form Fields", checked: false, icon: "📝", subFields: [
      { id: "ff-text", label: "1.1 Text Input", checked: false, required: false },
      { id: "ff-email", label: "1.2 Email Input", checked: false, required: false },
      { id: "ff-password", label: "1.3 Password Input", checked: false, required: false },
      { id: "ff-textarea", label: "1.4 Textarea", checked: false, required: false },
      { id: "ff-select", label: "1.5 Select Dropdown", checked: false, required: false },
      { id: "ff-checkbox", label: "1.6 Checkbox", checked: false, required: false },
      { id: "ff-radio", label: "1.7 Radio Button", checked: false, required: false },
      { id: "ff-date", label: "1.8 Date Picker", checked: false, required: false },
      { id: "ff-file", label: "1.9 File Upload", checked: false, required: false },
    ]},
    { id: "validation", label: "2. Validation", checked: false, icon: "✅", subFields: [
      { id: "vl-required", label: "2.1 Required Fields", checked: false, required: false },
      { id: "vl-email-format", label: "2.2 Email Format", checked: false, required: false },
      { id: "vl-min-max", label: "2.3 Min/Max Length", checked: false, required: false },
      { id: "vl-custom", label: "2.4 Custom Validation", checked: false, required: false },
    ]},
    { id: "form-actions", label: "3. Form Actions", checked: false, icon: "⚡", subFields: [
      { id: "fa-submit", label: "3.1 Submit Button", checked: false, required: false },
      { id: "fa-reset", label: "3.2 Reset Button", checked: false, required: false },
      { id: "fa-cancel", label: "3.3 Cancel Button", checked: false, required: false },
    ]},
  ],
  "gallery-page": [
    { id: "gallery-grid", label: "1. Gallery Grid", checked: false, icon: "🖼️", subFields: [
      { id: "gg-thumbnails", label: "1.1 Thumbnails", checked: false, required: false },
      { id: "gg-masonry", label: "1.2 Masonry Layout", checked: false, required: false },
      { id: "gg-hover-effect", label: "1.3 Hover Effects", checked: false, required: false },
    ]},
    { id: "lightbox", label: "2. Lightbox", checked: false, icon: "🔍", subFields: [
      { id: "lb-full-image", label: "2.1 Full Image View", checked: false, required: false },
      { id: "lb-navigation", label: "2.2 Navigation Arrows", checked: false, required: false },
      { id: "lb-captions", label: "2.3 Captions", checked: false, required: false },
    ]},
    { id: "categories", label: "3. Categories", checked: false, icon: "📁", subFields: [
      { id: "ct-filter", label: "3.1 Category Filter", checked: false, required: false },
      { id: "ct-tabs", label: "3.2 Category Tabs", checked: false, required: false },
    ]},
    { id: "upload", label: "4. Upload", checked: false, icon: "📤", subFields: [
      { id: "up-drag-drop", label: "4.1 Drag & Drop", checked: false, required: false },
      { id: "up-multi-select", label: "4.2 Multi-Select", checked: false, required: false },
      { id: "up-preview", label: "4.3 Preview", checked: false, required: false },
    ]},
  ],
  "inventory-page": [
    { id: "add-product", label: "1. Add Product", checked: false, icon: "➕", subFields: [
      { id: "ap-name", label: "1.1 Product Name", checked: false, required: false },
      { id: "ap-sku", label: "1.2 SKU", checked: false, required: false },
      { id: "ap-category", label: "1.3 Category", checked: false, required: false },
      { id: "ap-quantity", label: "1.4 Quantity", checked: false, required: false },
      { id: "ap-price", label: "1.5 Price", checked: false, required: false },
      { id: "ap-image", label: "1.6 Product Image", checked: false, required: false },
    ]},
    { id: "product-list", label: "2. Product List", checked: false, icon: "📦", subFields: [
      { id: "pl-table", label: "2.1 Data Table", checked: false, required: false },
      { id: "pl-search", label: "2.2 Search", checked: false, required: false },
      { id: "pl-filter", label: "2.3 Filters", checked: false, required: false },
      { id: "pl-actions", label: "2.4 Actions", checked: false, required: false },
    ]},
    { id: "stock-management", label: "3. Stock Management", checked: false, icon: "📊", subFields: [
      { id: "sm-low-stock", label: "3.1 Low Stock Alert", checked: false, required: false },
      { id: "sm-reorder", label: "3.2 Reorder Level", checked: false, required: false },
      { id: "sm-history", label: "3.3 Stock History", checked: false, required: false },
    ]},
    { id: "reports", label: "4. Reports", checked: false, icon: "📈", subFields: [
      { id: "rp-stock-report", label: "4.1 Stock Report", checked: false, required: false },
      { id: "rp-movement", label: "4.2 Movement Report", checked: false, required: false },
      { id: "rp-export", label: "4.3 Export Options", checked: false, required: false },
    ]},
  ],
  "landing-page": [
    { id: "hero-section", label: "1. Hero Section", checked: false, icon: "🎯", subFields: [
      { id: "hs-headline", label: "1.1 Headline", checked: false, required: false },
      { id: "hs-subheadline", label: "1.2 Subheadline", checked: false, required: false },
      { id: "hs-cta", label: "1.3 CTA Button", checked: false, required: false },
      { id: "hs-image", label: "1.4 Hero Image/Video", checked: false, required: false },
    ]},
    { id: "features", label: "2. Features Section", checked: false, icon: "✨", subFields: [
      { id: "fs-icons", label: "2.1 Feature Icons", checked: false, required: false },
      { id: "fs-titles", label: "2.2 Feature Titles", checked: false, required: false },
      { id: "fs-descriptions", label: "2.3 Feature Descriptions", checked: false, required: false },
    ]},
    { id: "testimonials", label: "3. Testimonials", checked: false, icon: "💬", subFields: [
      { id: "ts-quote", label: "3.1 Quote", checked: false, required: false },
      { id: "ts-author", label: "3.2 Author Name", checked: false, required: false },
      { id: "ts-photo", label: "3.3 Author Photo", checked: false, required: false },
      { id: "ts-company", label: "3.4 Company", checked: false, required: false },
    ]},
    { id: "pricing", label: "4. Pricing Section", checked: false, icon: "💰", subFields: [
      { id: "pr-plans", label: "4.1 Pricing Plans", checked: false, required: false },
      { id: "pr-features", label: "4.2 Plan Features", checked: false, required: false },
      { id: "pr-cta", label: "4.3 CTA Buttons", checked: false, required: false },
    ]},
    { id: "cta-section", label: "5. CTA Section", checked: false, icon: "📢", subFields: [
      { id: "ct-text", label: "5.1 CTA Text", checked: false, required: false },
      { id: "ct-button", label: "5.2 CTA Button", checked: false, required: false },
      { id: "ct-form", label: "5.3 Email Signup", checked: false, required: false },
    ]},
  ],
  "login-page": [
    { id: "login-form", label: "1. Login Form", checked: false, icon: "🔐", subFields: [
      { id: "lf-email", label: "1.1 Email/Username", checked: false, required: false },
      { id: "lf-password", label: "1.2 Password", checked: false, required: false },
      { id: "lf-remember", label: "1.3 Remember Me", checked: false, required: false },
      { id: "lf-submit", label: "1.4 Login Button", checked: false, required: false },
    ]},
    { id: "social-login", label: "2. Social Login", checked: false, icon: "🌐", subFields: [
      { id: "sl-google", label: "2.1 Google", checked: false, required: false },
      { id: "sl-facebook", label: "2.2 Facebook", checked: false, required: false },
      { id: "sl-github", label: "2.3 GitHub", checked: false, required: false },
    ]},
    { id: "forgot-password", label: "3. Forgot Password", checked: false, icon: "🔑", subFields: [
      { id: "fp-link", label: "3.1 Forgot Password Link", checked: false, required: false },
      { id: "fp-email", label: "3.2 Email Input", checked: false, required: false },
      { id: "fp-submit", label: "3.3 Reset Button", checked: false, required: false },
    ]},
    { id: "register-link", label: "4. Register Link", checked: false, icon: "📝", subFields: [
      { id: "rl-text", label: "4.1 Sign Up Text", checked: false, required: false },
      { id: "rl-link", label: "4.2 Register Link", checked: false, required: false },
    ]},
  ],
  "portfolio-page": [
    { id: "portfolio-grid", label: "1. Portfolio Grid", checked: false, icon: "🖼️", subFields: [
      { id: "pg-thumbnails", label: "1.1 Project Thumbnails", checked: false, required: false },
      { id: "pg-titles", label: "1.2 Project Titles", checked: false, required: false },
      { id: "pg-categories", label: "1.3 Categories", checked: false, required: false },
    ]},
    { id: "project-detail", label: "2. Project Detail", checked: false, icon: "📄", subFields: [
      { id: "pd-images", label: "2.1 Project Images", checked: false, required: false },
      { id: "pd-description", label: "2.2 Description", checked: false, required: false },
      { id: "pd-tech-stack", label: "2.3 Tech Stack", checked: false, required: false },
      { id: "pd-links", label: "2.4 Live/GitHub Links", checked: false, required: false },
    ]},
    { id: "filters", label: "3. Filters", checked: false, icon: "🔍", subFields: [
      { id: "fl-category", label: "3.1 Category Filter", checked: false, required: false },
      { id: "fl-tech", label: "3.2 Technology Filter", checked: false, required: false },
    ]},
    { id: "about", label: "4. About Section", checked: false, icon: "👤", subFields: [
      { id: "ab-bio", label: "4.1 Bio", checked: false, required: false },
      { id: "ab-skills", label: "4.2 Skills", checked: false, required: false },
      { id: "ab-experience", label: "4.3 Experience", checked: false, required: false },
    ]},
  ],
  "reports-dashboard": [
    { id: "report-filters", label: "1. Report Filters", checked: false, icon: "🔍", subFields: [
      { id: "rf-date-range", label: "1.1 Date Range", checked: false, required: false },
      { id: "rf-category", label: "1.2 Category", checked: false, required: false },
      { id: "rf-status", label: "1.3 Status", checked: false, required: false },
    ]},
    { id: "charts", label: "2. Charts & Graphs", checked: false, icon: "📊", subFields: [
      { id: "cg-line", label: "2.1 Line Chart", checked: false, required: false },
      { id: "cg-bar", label: "2.2 Bar Chart", checked: false, required: false },
      { id: "cg-pie", label: "2.3 Pie Chart", checked: false, required: false },
      { id: "cg-area", label: "2.4 Area Chart", checked: false, required: false },
    ]},
    { id: "data-tables", label: "3. Data Tables", checked: false, icon: "📋", subFields: [
      { id: "dt-sortable", label: "3.1 Sortable Columns", checked: false, required: false },
      { id: "dt-pagination", label: "3.2 Pagination", checked: false, required: false },
      { id: "dt-search", label: "3.3 Search", checked: false, required: false },
    ]},
    { id: "export", label: "4. Export Options", checked: false, icon: "📤", subFields: [
      { id: "ex-pdf", label: "4.1 Export PDF", checked: false, required: false },
      { id: "ex-csv", label: "4.2 Export CSV", checked: false, required: false },
      { id: "ex-excel", label: "4.3 Export Excel", checked: false, required: false },
    ]},
  ],
  "service-page": [
    { id: "services-list", label: "1. Services List", checked: false, icon: "🛠️", subFields: [
      { id: "sl-icons", label: "1.1 Service Icons", checked: false, required: false },
      { id: "sl-titles", label: "1.2 Service Titles", checked: false, required: false },
      { id: "sl-descriptions", label: "1.3 Descriptions", checked: false, required: false },
    ]},
    { id: "service-detail", label: "2. Service Detail", checked: false, icon: "📄", subFields: [
      { id: "sd-full-desc", label: "2.1 Full Description", checked: false, required: false },
      { id: "sd-features", label: "2.2 Features", checked: false, required: false },
      { id: "sd-pricing", label: "2.3 Pricing", checked: false, required: false },
    ]},
    { id: "process", label: "3. Process/How It Works", checked: false, icon: "📋", subFields: [
      { id: "pr-steps", label: "3.1 Steps", checked: false, required: false },
      { id: "pr-timeline", label: "3.2 Timeline", checked: false, required: false },
    ]},
    { id: "cta", label: "4. Call to Action", checked: false, icon: "📢", subFields: [
      { id: "ct-contact", label: "4.1 Contact Button", checked: false, required: false },
      { id: "ct-quote", label: "4.2 Get Quote", checked: false, required: false },
    ]},
  ],
  "settings-page": [
    { id: "profile-settings", label: "1. Profile Settings", checked: false, icon: "👤", subFields: [
      { id: "ps-name", label: "1.1 Name", checked: false, required: false },
      { id: "ps-email", label: "1.2 Email", checked: false, required: false },
      { id: "ps-avatar", label: "1.3 Avatar", checked: false, required: false },
      { id: "ps-bio", label: "1.4 Bio", checked: false, required: false },
    ]},
    { id: "security-settings", label: "2. Security Settings", checked: false, icon: "🔐", subFields: [
      { id: "ss-password", label: "2.1 Change Password", checked: false, required: false },
      { id: "ss-2fa", label: "2.2 Two-Factor Auth", checked: false, required: false },
      { id: "ss-sessions", label: "2.3 Active Sessions", checked: false, required: false },
    ]},
    { id: "notification-settings", label: "3. Notification Settings", checked: false, icon: "🔔", subFields: [
      { id: "ns-email", label: "3.1 Email Notifications", checked: false, required: false },
      { id: "ns-push", label: "3.2 Push Notifications", checked: false, required: false },
      { id: "ns-sms", label: "3.3 SMS Notifications", checked: false, required: false },
    ]},
    { id: "appearance", label: "4. Appearance", checked: false, icon: "🎨", subFields: [
      { id: "ap-theme", label: "4.1 Theme (Light/Dark)", checked: false, required: false },
      { id: "ap-language", label: "4.2 Language", checked: false, required: false },
      { id: "ap-timezone", label: "4.3 Timezone", checked: false, required: false },
    ]},
  ],
};
