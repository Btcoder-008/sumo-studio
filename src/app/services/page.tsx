...
const serviceCards = [
  ...
  { id: "super-services", label: "Super Services", icon: "⚡", href: "/services", color: "orange" },
  { id: "super-products", label: "Super Products", icon: "📦", href: "/services", color: "purple" },
];
...
export default function Services() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 overflow-hidden">
      ...
      <MobileLayout title="Services" backLink="/dashboard" navItems={navItems}>
