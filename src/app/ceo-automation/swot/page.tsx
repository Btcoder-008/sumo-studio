        ...
        <main className="flex-1 overflow-auto">
          <header className="bg-white/80 backdrop-blur-md shadow-lg border-b border-white/20 p-6">
            <div className="flex items-center gap-4">
              <Link href="/ceo-automation" className="text-green-400 hover:text-green-500 transition-colors text-2xl cursor-pointer">
                ←
              </Link>
              <h2 className="text-3xl font-bold text-gray-800">SWOT Analysis 📊</h2>
            </div>
          </header>
          ...
          <div className="p-8">
            {/* SWOT Grid */}
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6">SWOT Quadrants</h3>
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6">How to Better</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {swotQuadrants.map((quadrant) => (
                  <div
            ...
            {isSubmitted && (
              <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-white/30">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">SWOT Summary</h3>
